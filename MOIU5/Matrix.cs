...
namespace MOIU5
{
    class Matrix<T> where T : IFormattable
    {
        private T[,] data;
        private T[,] Data
        {
        ...
        public static Matrix operator *(Matrix matrix, T value)
        {
        ...
        public static Matrix operator *(T value, Matrix matrix)
        {            
            return matrix * value;
        }
        ...
        public static Matrix GetRow(int length, T value = 0)
        {
        ...
        public static Matrix GetCol(int length, T value = 0)
        {
        ...
        {
            Matrix diagonolize = GetDiagonolizeUnder();
            T det = 0;
